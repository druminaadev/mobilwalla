...
import { CATEGORIES, ALL_PRODUCTS, BEST_SELLERS } from '../../data/mockShopData';
    ...
    <View style={styles.root}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: Math.max(insets.bottom, 40) }}>
        ...
        <Animated.View entering={FadeInUp.delay(200)}>
          {renderSectionHeader('Shop by Category', () => navigation.navigate('ProductList', { title: 'All Products' }))}
        ...
        <Animated.View entering={FadeInUp.delay(300)}>
          {renderSectionHeader('Best Sellers', () => navigation.navigate('ProductList', { title: 'Best Sellers' }))}
        ...
        {CATEGORIES.map((cat, index) => {
          ...
          return (
            <Animated.View key={cat.id} entering={FadeInUp.delay(400 + index * 100)}>
              {renderSectionHeader(cat.name, () => navigation.navigate('ProductList', { categoryId: cat.id, title: cat.name }))}
              <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.productScroll}>
